...
const GlassAvatar = React.forwardRef(({ className, glowEffect = true, ...props }, ref) => (
  <div className="relative">
    {glowEffect && (
      <div
        className="absolute -inset-1 rounded-full bg-linear-to-r from-cyan-500/40 via-blue-500/40 to-purple-500/40 blur-md opacity-70" />
    )}
...
const GlassAvatarImage = React.forwardRef(({ className, ...props }, ref) => (
