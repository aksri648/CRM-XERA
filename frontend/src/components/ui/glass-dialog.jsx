  ...
  <GlassDialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "rounded-2xl border border-slate-200 border-white/20 p-6 dark:border-slate-800",
      ...
      <DialogPrimitive.Close
        className="absolute right-4 top-4 rounded-lg p-1 text-white/60 transition-all hover:text-white hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-white/50">
        <X className="h-4 w-4" />
