...
const GlassCard = React.forwardRef(({ className, glowEffect = true, children, ...props }, ref) => {
  return (
    <div className="relative">
      {glowEffect && (
        <div
          className="absolute -inset-1 rounded-2xl bg-linear-to-r from-cyan-500/30 via-blue-500/30 to-purple-500/30 blur-xl opacity-70" />
      )}
      <div
        ref={ref}
        className={cn(
          "relative rounded-2xl border border-slate-200 border-white/20 dark:border-slate-800",
...
const GlassCardHeader = React.forwardRef(({ className, ...props }, ref) => <div
  ref={ref}
